import { SRS_STATE_COLORS } from '../../lib/utils'

/**
 * DeckStatsBar — visual breakdown of card states for a deck
 */
...
/**
 * StatCard — single number highlight
 */
export function StatCard({ label, value, color, sub }) {
  return (
    <div className="card p-4 text-center">
      <div className="font-display text-3xl font-bold mb-1" style={{ color: color || 'var(--text-primary)' }}>
        {value}
      </div>
