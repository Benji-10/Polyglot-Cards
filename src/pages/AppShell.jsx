...
export default function AppShell() {
  ...
  // Build sidebar class without template literals
  const sidebarClass = [
    'fixed inset-y-0 left-0 z-40 flex flex-col flex-shrink-0 transition-transform duration-300',
  ...
  return (
    <div className="h-screen flex overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
      ...
      <aside className={sidebarClass} style={{ width: '220px', background: 'var(--bg-surface)', borderRight: '1px solid var(--border)' }}>
